...
const ::_pbi::DescriptorTable descriptor_table_mc_2fcomm_2fpbtexture_2eproto = {
    false, false, 149, descriptor_table_protodef_mc_2fcomm_2fpbtexture_2eproto,
...
void PBTexture::InternalSwap(PBTexture* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(PBTexture, _impl_.wrapt_)
      + sizeof(PBTexture::_impl_.wrapt_)
