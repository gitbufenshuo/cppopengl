...
type Accessor struct {
	...
	Max           []float32 `protobuf:"fixed32,6,rep,packed,name=max,proto3" json:"max,omitempty"`
	Min           []float32 `protobuf:"fixed32,7,rep,packed,name=min,proto3" json:"min,omitempty"`
}
...
func (x *Accessor) GetMax() []float32 {
	if x != nil {
		return x.Max
	}
	return nil
...
func (x *Accessor) GetMin() []float32 {
	if x != nil {
		return x.Min
	}
	return nil
...
var file_mc_comm_gltf_proto_rawDesc = []byte{
	...
	0x02, 0x52, 0x03, 0x6d, 0x61, 0x78, 0x12, 0x10, 0x0a, 0x03, 0x6d, 0x69, 0x6e, 0x18, 0x07, 0x20,
	0x03, 0x28, 0x02, 0x52, 0x03, 0x6d, 0x69, 0x6e, 0x22, 0x21, 0x0a, 0x05, 0x41, 0x73, 0x73, 0x65,
