...
type PBLight struct {
	...
	Cutoff      *PBVec3 `protobuf:"bytes,6,opt,name=cutoff,proto3" json:"cutoff,omitempty"`           // spot light 专用
}
...
func (x *PBLight) GetCutoff() *PBVec3 {
	if x != nil {
		return x.Cutoff
	}
	return nil
...
var file_mc_comm_pbnode_proto_rawDesc = []byte{
	...
	0x74, 0x22, 0x32, 0x0a, 0x06, 0x50, 0x42, 0x56, 0x65, 0x63, 0x33, 0x12, 0x0c, 0x0a, 0x01, 0x78,
	...
	0x28, 0x02, 0x52, 0x01, 0x7a, 0x22, 0xee, 0x01, 0x0a, 0x07, 0x50, 0x42, 0x4c, 0x69, 0x67, 0x68,
	...
	0x64, 0x18, 0x05, 0x20, 0x01, 0x28, 0x05, 0x52, 0x04, 0x6b, 0x69, 0x6e, 0x64, 0x12, 0x27, 0x0a,
	0x06, 0x63, 0x75, 0x74, 0x6f, 0x66, 0x66, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0f, 0x2e,
	0x6d, 0x63, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x2e, 0x50, 0x42, 0x56, 0x65, 0x63, 0x33, 0x52, 0x06,
	0x63, 0x75, 0x74, 0x6f, 0x66, 0x66, 0x42, 0x09, 0x5a, 0x07, 0x6d, 0x63, 0x2f, 0x63, 0x6f, 0x6d,
...
var file_mc_comm_pbnode_proto_depIdxs = []int32{
	...
	4,  // 9: mc.comm.PBLight.cutoff:type_name -> mc.comm.PBVec3
