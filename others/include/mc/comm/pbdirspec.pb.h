...
class PBDirSpec final :
 ...
 public:
  ...
  enum : int {
    ...
    kTextureListFieldNumber = 5,
    kModelListFieldNumber = 6,
    kShaderProgramListFieldNumber = 7,
    kMaterialListFieldNumber = 8,
    kSceneListFieldNumber = 9,
    kNodeListFieldNumber = 10,
